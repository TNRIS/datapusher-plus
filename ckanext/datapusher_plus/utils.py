...
# JobError is re-exported: most of the codebase raises and catches it as
# utils.JobError, and it must stay the same class as the one HTTPError extends.
from .job_exceptions import HTTPError, JobError  # noqa: F401
